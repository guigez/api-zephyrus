...
-- AddForeignKey
ALTER TABLE "sugestions" ADD CONSTRAINT "sugestions_id_order_fkey" FOREIGN KEY ("id_order") REFERENCES "orders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "deliveries" ADD CONSTRAINT "deliveries_id_deliveryman_fkey" FOREIGN KEY ("id_deliveryman") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
